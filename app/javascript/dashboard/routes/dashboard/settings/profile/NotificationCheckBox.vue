...
<template>
  ...
  >
    <input
      v-model="localFlags"
      class="mt-1 flex-shrink-0 border-ash-200 border checked:border-none checked:bg-woot-500 dark:checked:bg-woot-500 shadow appearance-none rounded-[4px] w-4 h-4 focus:ring-1 after:content-[''] after:text-white checked:after:content-['✓'] after:flex after:items-center after:justify-center after:text-center after:text-xs after:font-bold after:relative"
      type="checkbox"
      :value="localValue"
      @input="handleInput"
    />
